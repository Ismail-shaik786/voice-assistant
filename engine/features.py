...
genai.configure(api_key="AIzaSyAZyG4MMME7fTVFkrtKodf350tIIVGnx_Y")
    ...
    if app_name != "":
        ...
        try:
           if app_name in system_apps:
              ...
              os.startfile(system_apps[app_name])
...
def findContact(query):
    # Clean words
    words_to_remove = [ASSISTANCE_NAME, 'make', 'a', 'to', 'phone', 'call', 'send', 'message', 'whatsapp', 'video']
